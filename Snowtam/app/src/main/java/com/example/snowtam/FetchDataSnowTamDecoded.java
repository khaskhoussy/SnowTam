...
public class FetchDataSnowTamDecoded {
    ...
    public String SnowtamDecoded (String fetchedSnowtam, String AirportName) {
        ...
        if (split[1].contains("B)")) {
            ...
            if (Alphabets.get(0) != "") {
                SnowtamDecoded += "* Aerodrome : " + AirportName + " - " + Alphabets.get(0);
                SnowtamDecoded += "\n \n";
            }

            if (Alphabets.get(1) != "") {
                temp = removeSpace(Alphabets.get(1));
            ...
            if (Alphabets.get(18) != "") {
                temp = removeSpace(Alphabets.get(18));
                String day = temp.substring(2, 4);
